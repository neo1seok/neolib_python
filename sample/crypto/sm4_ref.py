...
if __name__ == '__main__':
	...
	cipher = neo_sm4.encrypt(tobytes('0123456789abcdeffedcba9876543210'),tobytes('0123456789abcdeffedcba9876543210'))
	dec = neo_sm4.decrypt(cipher,tobytes('0123456789abcdeffedcba9876543210'))

	print(hex(cipher_num)[2:].replace('L', ''))
	print(tohexstr(cipher),tohexstr(dec))
